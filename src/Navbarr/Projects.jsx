...
import { MapPin, Building, Users, Calendar, ChevronDown, ChevronUp, ExternalLink, Share2, Bookmark, Eye, Award, Target, Zap } from 'lucide-react';

// Mock images for demonstration
import pic1 from '../assets/projectImg/proj1.jpg';
import pic2 from '../assets/projectImg/proj2.jpg';
import pic3 from '../assets/projectImg/proj3.jpg';
import pic4 from '../assets/projectImg/bg_img.jpg';
    ...
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-gray-50 via-white to-teal-50/30">
      ...
      <div className="relative z-10 py-16">
        ...
        <div className="text-center mb-16 relative">
          <div className="absolute inset-0 bg-white/20 backdrop-blur-sm rounded-3xl max-w-5xl mx-auto"></div>
          <div className="relative z-10 py-12 px-8">
            ...
            <p className="text-xl md:text-2xl text-gray-700 max-w-3xl mx-auto leading-relaxed">
              Showcasing our commitment to sustainable development and innovative solutions that transform communities
            </p>
